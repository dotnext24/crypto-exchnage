        ...
        return (
            ...
            <div id="currency_droplist_from" class="cl-droplist  searchable sc-gqjmRU gywoMT">
                ...
                <ul className="sc-htpNat sc-fjdhpX bZoPFN">
                    ...
                    return(<li onClick={()=>this.onSelect(key)} class="sc-ifAKCX sc-cSHVUG ZfCCL"><button class="sc-kAzzGY cCVEey" type="button" tabindex="0"><div class="coin-list-item"><div class="coin-info"><i class="coin-icon"><img height="24" width="24" src={TokenLogo(key)}/></i><span class="coin-name" style={{fontWeight:'normal'}}><span class="coin-ticker" style={{fontWeight:'bolder',fontSize:'15px'}}>{currency.SYMBOL}</span>{currency.NAME}</span></div><div class="icons"><span class="fixed-rate-status">-</span></div></div></button></li>)
                    })}
                    <li class="sc-ifAKCX sc-cSHVUG ZfCCL"><button class="active sc-kAzzGY cCVEey" type="button" tabindex="0"><div class="coin-list-item"><div class="coin-info"><i class="coin-icon"></i><span class="coin-name"><span class="coin-ticker">btc</span>Bitcoin</span></div><div class="icons"><span class="fixed-rate-status"><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12.6667 6.9668H3.33333C2.59695 6.9668 2 7.56375 2 8.30013V12.9668C2 13.7032 2.59695 14.3001 3.33333 14.3001H12.6667C13.403 14.3001 14 13.7032 14 12.9668V8.30013C14 7.56375 13.403 6.9668 12.6667 6.9668Z" stroke="#10D078" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M4.66675 6.9668V4.30013C4.66675 3.41608 5.01794 2.56823 5.64306 1.94311C6.26818 1.31799 7.11603 0.966797 8.00008 0.966797C8.88414 0.966797 9.73198 1.31799 10.3571 1.94311C10.9822 2.56823 11.3334 3.41608 11.3334 4.30013V6.9668" stroke="#10D078" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg></span></div></div></button></li>
