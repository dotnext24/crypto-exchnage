        ...
        <section class="connect-wallet" >
         <a onClick={this.handleShowConnectWalletPopup}>Connect Wallet</a>
                    ...
                    <div class="exchange-block is-processing styled__ExchangeBlock-th509d-0 fzipjT">
                        <div class="currency-block styled__WrapperCurrency-g3y0ua-0 rGnYa send-box" style={{}}>
                            ...
                            <div class="currency-block__currency styled__CurrencyButtonWrapper-g3y0ua-3 jCKRds">
                              <button class="currency-block__switch switchable styled__CurrencySwitch-g3y0ua-4 ZmPKt" type="button" id="currency_button_from">
                                <div class="full-name-label">US Dollar</div>usd
                              </button>
                            </div>
                            ...
                            <div class="styled__DropListWrapper-tlgv5r-0 bZzVdI">
                                <div id="currency_droplist_from" class="cl-droplist  searchable sc-gqjmRU gywoMT">
                                    ...
                                    <ul class="sc-dnqmqq sc-VigVT gKLAiY"></ul></div>
                            </div>
                ...
                <div class="currency-block styled__WrapperCurrency-g3y0ua-0 rGnYa receive-box">
                    ...
                    <div class="currency-block__currency styled__CurrencyButtonWrapper-g3y0ua-3 jCKRds">
                        <button class="currency-block__switch switchable styled__CurrencySwitch-g3y0ua-4 ZmPKt" type="button" id="currency_button_to">
                            <div class="full-name-label">Ethereum</div>eth
                        </button>
                    </div>
                    <div class="styled__DropListWrapper-tlgv5r-0 bZzVdI">
